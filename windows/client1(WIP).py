...
global co,Vittoria,num,colorv,pl1vitt,pl2vitt,turn,player1,player2
#game
player1=None
player2=None
turn=1
...
def gameplay(K,num):
    ...
    global cont,pl1,pl2,a,b,c,d,e,f,g,h,i
##    server.receive(pl1)
##    server.receive(pl2)
##    pl1.decode(utf-8)
##    pl2.decode(utf-8)
...
##
    ...
    for z in pl2:
        if z == 1:
            a.configure(text="O", foreground=colorpl2)
        elif z == 2:
            b.configure(text="O", foreground=colorpl2)
        elif z == 3:
            c.configure(text="O", foreground=colorpl2)
        elif z == 4:
            d.configure(text="O", foreground=colorpl2)
        elif z == 5:
            e.configure(text="O", foreground=colorpl2)
        elif z == 6:
            f.configure(text="O", foreground=colorpl2)
        elif z == 7:
            g.configure(text="O", foreground=colorpl2)
        elif z == 8:
            h.configure(text="O", foreground=colorpl2)
        elif z == 9:
            i.configure(text="O", foreground=colorpl2)
...
def callback(K,num):#already tryed outside
    global cont,Vittoria,co,color,pl1vitt,pl2vitt,turn,btn,a,b,c,d,e,f,g,h,i,x
...
def start(l,a1,a2): #main play and reset values for win possibilities
        global a,b,c,d,e,f,g,h,i,x,Vittoria,pl1vitt,pl2vitt,turn,end,co,cont,pl1,pl2,win,color,colorv,colorc,colorpl1,colorpl2
#values reset
